...
SVG_BY_FIGURE_ID: dict[str, str] = {
    "fig:aasu": _svg_wrap(
        r"""
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 320" role="img" aria-label="AASU components diagram">
  <defs>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 980 240" role="img" aria-label="Governance lifecycle diagram">
  ...
  <text x="95" y="128" text-anchor="middle" class="tB">P,M,R,T,K</text>
